    ...
    <div style={{minHeight: '100vh', display: 'flex', flexDirection: 'column', background: THEME.cream}}>
      ...
      <footer role="contentinfo" style={{background: THEME.blush, borderTop: `1px solid ${THEME.rose}`, padding: '48px 20px 32px'}}>
        <div style={{maxWidth: 1200, margin: '0 auto'}}>
          ...
          {/* Business Details Section - GMC Compliance */}
          <div style={{borderTop: `1px solid ${THEME.rose}`, paddingTop: 24, marginBottom: 24}}>
            <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 20, fontSize: 12, color: THEME.textLight}}>
              <div>
                <h5 style={{fontWeight: 600, marginBottom: 8, color: THEME.text, fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.5px'}}>Contact</h5>
                <p style={{marginBottom: 4}}><a href="mailto:hello@homeandverse.co.uk" style={{color: THEME.textLight, textDecoration: 'none'}}>hello@homeandverse.co.uk</a></p>
                <p><a href="tel:+441905616006" style={{color: THEME.textLight, textDecoration: 'none'}}>01905 616006</a></p>
              </div>
              <div>
                <h5 style={{fontWeight: 600, marginBottom: 8, color: THEME.text, fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.5px'}}>Address</h5>
                <p style={{lineHeight: 1.4}}>DM Brands Ltd<br/>79 Waterworks Road<br/>Worcester, WR1 3EZ</p>
              </div>
              <div>
                <h5 style={{fontWeight: 600, marginBottom: 8, color: THEME.text, fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.5px'}}>Company Info</h5>
                <p style={{marginBottom: 4}}>Company No: 07517652</p>
                <p>VAT No: GB 851 815 128</p>
              </div>
              <div>
                <h5 style={{fontWeight: 600, marginBottom: 8, color: THEME.text, fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.5px'}}>Secure Payments</h5>
                <div style={{display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center'}}>
                  <span style={{background: '#fff', padding: '4px 8px', borderRadius: 3, fontSize: 10, fontWeight: 600, color: '#1a1f71'}}>VISA</span>
                  <span style={{background: '#fff', padding: '4px 8px', borderRadius: 3, fontSize: 10, fontWeight: 600, color: '#eb001b'}}>MC</span>
                  <span style={{background: '#006fcf', padding: '4px 8px', borderRadius: 3, fontSize: 10, fontWeight: 600, color: '#fff'}}>AMEX</span>
          ...
          <div className="footer-bottom" style={{borderTop: `1px solid ${THEME.rose}`, paddingTop: 20, display: 'flex', justifyContent: 'space-between', fontSize: 12, color: THEME.textLight, flexWrap: 'wrap', gap: 12}}>
            ...
            <div style={{display: 'flex', gap: 16, flexWrap: 'wrap'}}>
              ...
              <span onClick={() => navigate('delivery')} style={{cursor: 'pointer'}}>Shipping</span>
              <span onClick={() => navigate('returns')} style={{cursor: 'pointer'}}>Returns</span>
            </div>
          </div>
        </div>
      </footer>
  ...
  return (
    <div style={{maxWidth: 800, margin: '0 auto', padding: '60px 20px'}}>
      ...
      <div style={{fontSize: 15, lineHeight: 1.8, color: '#444'}}>
        ...
        <p style={{marginBottom: 24}}>
          Home & Verse is a trading name of DM Brands Ltd, a company registered in England and Wales (Company No. 07517652). We are the data controller responsible for your personal data.
        </p>
        <p style={{marginBottom: 16}}>
          <strong>Registered Address:</strong><br/>
          DM Brands Ltd<br/>
          79 Waterworks Road<br/>
          Worcester, WR1 3EZ<br/>
          United Kingdom
        </p>
        <p style={{marginBottom: 8}}><strong>Email:</strong> hello@homeandverse.co.uk</p>
        <p style={{marginBottom: 8}}><strong>Phone:</strong> 01905 616006</p>
        <p style={{marginBottom: 24}}><strong>VAT Number:</strong> GB 851 815 128</p>
  ...
  return (
    <div style={{maxWidth: 800, margin: '0 auto', padding: '60px 20px'}}>
      ...
      <div style={{fontSize: 15, lineHeight: 1.8, color: '#444'}}>
        ...
        <p style={{marginBottom: 16}}>
          Home & Verse is a trading name of DM Brands Ltd, a company registered in England and Wales (Company No. 07517652, VAT No. GB 851 815 128). These terms govern your use of homeandverse.co.uk and any purchases you make.
        </p>
        <p style={{marginBottom: 24}}>
          <strong>Registered Address:</strong> 79 Waterworks Road, Worcester, WR1 3EZ, United Kingdom<br/>
          <strong>Email:</strong> hello@homeandverse.co.uk | <strong>Phone:</strong> 01905 616006
        </p>
